...
function setup()
{
  ...
  box3 = new Box(475,100,200,20);
  box4 = new Box(480, 100, 60, 60);
  box5 = new Box(430, 100, 60, 60);
  box6 = new Box(475, 100, 200, 30);
  box7 = new Box(480, 100, 70, 70);
  box8 = new Box(420, 100, 70, 70);
  box9 = new Box(475, 100, 220, 30);
  box10 = new Box(480, 100, 70, 70);
  box11 = new Box(450, 100, 70, 70);
  box12 = new Box(472,100,220,30);
  box13 = new Box(475,100,220,30);
  ...
  rope = new Rope(ball.body,{x:100, y:0});
